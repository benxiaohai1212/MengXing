...
%>
<link href="<%=contextPath%>/css/header.css" type="text/css" rel="stylesheet"></link>
<link href="<%=contextPath%>/css/juicyslider.css" type="text/css" rel="stylesheet"></link>
<script src="<%=contextPath%>/js/menu.js" type="text/javascript"></script>
        <script src="<%=contextPath%>/js/jquery.min.js"></script>
        <script src="<%=contextPath%>/js/jquery-ui.min.js"></script>
        <script src="<%=contextPath%>/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="<%=contextPath%>/js/juicyslider.js"></script>
...
<div class="header">
	...
	<div class="nav" style="border-left:1px solid #ccc;border-right:1px solid #ccc;">
		<ul>
			<li><a class="gradient" href="<%=contextPath %>/index.jsp">首页</a></li>
			<li><a class="gradient" href="<%=contextPath %>/cn/mengxing.jsp">公司简介</a></li>
			<li><a class="gradient" href="<%=contextPath %>/cn/product/index.jsp">产品展示</a></li>
			<li><a class="gradient" href="<%=contextPath %>/cn/news/index.jsp">公司动态</a></li>
			<li><a class="gradient" href="<%=contextPath%>/cn/networksales.jsp">销售网络</a></li>
			<li><a class="gradient" href="<%=contextPath %>/cn/about/contact.jsp">联系我们</a></li>
		</ul>
	</div>
</div>
<div style="width:980px;height:240px;margin:0px auto;margin-bottom:-20px;">
<script type="text/javascript">
	var img=new Array();
	var txt=new Array();
	var lnk=new Array();
...
<div id="myslider2" class="juicyslider" style="display: none;">
    <ul>
        <li><img src="<%=contextPath %>/images/3-2_02old.jpg" alt=""></li>
        <li><img src="<%=contextPath %>/images/2-2_02old.jpg" alt=""></li>
        <li><img src="<%=contextPath %>/images/4-2_02.jpg" alt=""></li>
        <li><img src="<%=contextPath %>/images/3-2_02.jpg" alt=""></li>
        <li><img src="<%=contextPath %>/images/2-2_02.jpg" alt=""></li>
        <li><img src="<%=contextPath %>/images/1-2_02.jpg" alt=""></li>
    </ul>
    <!-- <div class="mask"></div> -->
</div>
