...
<html lang="en">
	...
	<body>
		...
		<div class="home_v2">
			<div class="img">
				<img src="<%=contextPath %>/images/index_cn_logo.jpg" height="100px"/>
			</div>
			<div class=home>
				<a href="<%=contextPath %>/en/index.jsp"><img title="英文" src="<%=contextPath%>/images/usa-flag.jpg"/></a><a href="<%=contextPath %>/index.jsp"><img title="简体中文" src="<%=contextPath%>/images/chs-flag.jpg"/></a><a href="<%=contextPath %>/en/index.jsp"><img title="英文" src="<%=contextPath%>/images/uk-flag.jpg"/></a>
			</div>
		...
		<div class="home_v6">
			<div>
				<div class="home">
					<div class="home_title">公司简介</div>
					<div class="home_content">
						<p>山东蒙星机械有限公司是中国农业机械工业协会旋耕机分会理事单位，是专业从事旋耕刀和其它非标农机刀具生产的企业。生产的蒙星牌T.S.全系列旋耕刀经部级鉴定合格，已获取中华人民共和国农业部颁发的农业机械推广许可证；</p>
						<p>本公司经济实力雄厚，有一支高素质的技术队伍，公司员工已达到260人 其中工程</p>
						<div><a href="<%=contextPath %>/cn/mengxing.jsp">>> 点击这里查看更多</a></div>
					</div>
				</div>
				<div class="home right">
					<div class="home_title">产品系列</div>
					<div class="home_content">
						<table style="width:600px">
							<tr>
								<td><img src="<%=contextPath %>/images/product/xgdxl/MSM-047.jpg" height="80" width="150"/></td><td width="150">■ <a href="<%=contextPath%>/cn/product/xgdxl/index.jsp">旋耕刀系列</a></td>
								<td><img src="<%=contextPath %>/images/product/tygldj/MSR-029.jpg" height="80" width="150"/></td><td>■ <a href="<%=contextPath%>/cn/product/tygldj/index.jsp">割草刀系列</a></td>
							</tr>	
							<tr>
								<td><img src="<%=contextPath %>/images/product/kkdxl/MXDH-006.jpg" height="80" width="150"/></td><td width="150">■ <a href="<%=contextPath%>/cn/product/kkdxl/index.jsp">圆盘耙系列</a></td>
								<td><img src="<%=contextPath %>/images/product/qitaxl/MSO-002.jpg" height="80" width="150"/></td><td>■ <a href="<%=contextPath%>/cn/product/qitaxl/index.jsp">其他刀系列</a></td>
							</tr>
						</table>
					</div>
				</div>
			...
			<div style="margin:0px;padding:0px;">
				...
				<div class="home2 right2">
					<div class="home_title">新闻室</div>
					<div class="home_content">
						<ul>
							<li>山东蒙星机械有限公司是中国农业机械工业协会旋耕机分会理事单位</li>
						</ul>
					</div>
				</div>
				<div class="clear"></div>
		...
		<div class="home_footer">
			<table style="width:400px;">
				<tr><td>电话：（+86）0539 5735999</td><td>传真：（+86）0539 5736129</td></tr>
				<tr><td>地址：山东临沂费县胡阳县新胜村</td><td>邮编：273405</td></tr>
			</table>
		</div>
